  ...
  return React.createElement(React.Fragment,null,
    ...
    showFilters&&React.createElement("div",{style:{padding:16,background:"#FAFAF7",borderRadius:20,marginBottom:16,animation:"fadeSlideUp 0.2s ease",border:"1.5px solid #F0EFE8"}},
      ...
      React.createElement("div",null,
        React.createElement("div",{style:{fontSize:12,color:"#888780",marginBottom:8,fontWeight:600}},"카테고리 (제외할 항목 선택)"),
        React.createElement("div",{style:{display:"flex",gap:6,flexWrap:"wrap"}},
          React.createElement(FilterChip,{selected:excludedCategories.size===0,onClick:function(){toggle("all");}},"전체"),
